...
/***/ "./src/actions/handlers/handleSignIn.ts":
/*!**********************************************!*\
  !*** ./src/actions/handlers/handleSignIn.ts ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var fetchAccessToken = function (context) { return __awaiter(void 0, void 0, Promise, function () {
    var e_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, context.auth.getTokenSilently()];
...
var handleSignIn = function (context) { return function (args) {
    if (args === void 0) { args = {}; }
    return __awaiter(void 0, void 0, void 0, function () {
        var isSilent, accessToken, e_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    isSilent = args.isSilent;
                    return [4 /*yield*/, fetchAccessToken(context)];
                case 1:
                    accessToken = _a.sent();
                    _a.label = 2;
                case 2:
                    _a.trys.push([2, 5, , 6]);
                    if (!(!accessToken && !isSilent)) return [3 /*break*/, 4];
                    return [4 /*yield*/, context.auth.loginWithRedirect()];
                case 3:
                    _a.sent();
                    return [2 /*return*/];
                case 4:
                    ...
                    context.events.signIn.emit({ isAuthenticated: context.state.isAuthenticated, accessToken: accessToken });
                    return [3 /*break*/, 6];
                case 5:
                    e_2 = _a.sent();
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (handleSignIn);


/***/ }),

/***/ "./src/actions/handlers/handleSignOut.ts":
/*!***********************************************!*\
  !*** ./src/actions/handlers/handleSignOut.ts ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var handleSignOut = function (context) { return function () { return __awaiter(void 0, void 0, void 0, function () {
    var e_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, context.auth.logout({
                        logoutParams: {
            ...
            case 2:
                e_1 = _a.sent();
                context.events.signOut.emit({ success: false, error: e_1.message });
                return [3 /*break*/, 3];
            case 3: return [2 /*return*/];
        }
    });
}); }; };
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (handleSignOut);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   getSdkActions: () => (/* binding */ getSdkActions)
/* harmony export */ });
/* harmony import */ var _handlers_handleSignOut__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./handlers/handleSignOut */ "./src/actions/handlers/handleSignOut.ts");
/* harmony import */ var _handlers_handleSignIn__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./handlers/handleSignIn */ "./src/actions/handlers/handleSignIn.ts");


var getSdkActions = function (context) { return ({
    signOut: (0,_handlers_handleSignOut__WEBPACK_IMPORTED_MODULE_0__["default"])(context),
    signIn: (0,_handlers_handleSignIn__WEBPACK_IMPORTED_MODULE_1__["default"])(context)
}); };


/***/ }),

/***/ "./src/context/events/eventHandler.ts":
/*!********************************************!*\
  !*** ./src/context/events/eventHandler.ts ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var createEventHandler = function (eventName) {
    return {
        emit: function (data) { return document.dispatchEvent(new CustomEvent(eventName, { detail: data })); },
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _eventHandler__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./eventHandler */ "./src/context/events/eventHandler.ts");

var events = {
    signIn: (0,_eventHandler__WEBPACK_IMPORTED_MODULE_0__.createEventHandler)("SIGN_IN_EVENT"),
    signOut: (0,_eventHandler__WEBPACK_IMPORTED_MODULE_0__.createEventHandler)("SIGN_OUT_EVENT")
};
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _events__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./events */ "./src/context/events/index.ts");
/* harmony import */ var _state__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./state */ "./src/context/state/index.ts");
...
var context = {
    ...
    auth: new _auth0_auth0_spa_js__WEBPACK_IMPORTED_MODULE_2__.Auth0Client({
...
var createSdk = function (context) { return ({
    getState: function () { return JSON.parse(JSON.stringify(context.state)); },
    actions: (0,_actions__WEBPACK_IMPORTED_MODULE_0__.getSdkActions)(context),
    events: context.events
}); };
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (createSdk);
...
window.AccountSDK = (0,_sdk__WEBPACK_IMPORTED_MODULE_0__["default"])(_context__WEBPACK_IMPORTED_MODULE_1__["default"]);
// Silently fetch session when SDK loaded on page
var readyStateCheckInterval = setInterval(function () {
    if (document.readyState === 'complete') {
        clearInterval(readyStateCheckInterval);
        window.AccountSDK.actions.signIn({ isSilent: true }).then(function () {
